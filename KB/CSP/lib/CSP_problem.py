...
class Variable(object):
    ...
    def _init_(self, name, domain, position=None):
        """Variable
        name a string
...
class Constraint(object):
    ...
    * string: a string for printing the constraints. All of the strings must be unique.
    for the variables
    """
    def _init_(self, scope, condition, string=None, position=None):
        self.scope = scope
        self.condition = condition
        if string is None:
            self.string = self.condition._name_ + str(self.scope)
        else:
            self.string = string
...
class CSP(object):
    ...
    * var_to_const, a variable to set of constraints dictionary
    """
    def _init_(self, title, variables, constraints):
        """title is a string
